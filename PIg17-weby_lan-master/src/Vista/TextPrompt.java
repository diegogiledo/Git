...
public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
	 ...
	 *
	 * Show.AWLAYS (default) - always show the prompt Show.Focus_GAINED - show the prompt when the component gains focus (and hide the prompt when focus is lost) Show.Focus_LOST - show the prompt when the
	 * component loses focus (and hide the prompt when focus is gained)
	 *
	 * @param show
	 *            a valid Show enum
	 */
